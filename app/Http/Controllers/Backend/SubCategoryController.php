...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request)
    {
        $request->validate([
            ...
            'category_id.required' => 'Please Sellect Any Option',
        ]);
    ...
    public function SubSubCategoryStore(Request $request)
    {
        $request->validate([
            ...
            'subsubcategory_name_hin.required' => 'Input SubCategory Hindi Name',
            'category_id.required' => 'Please Sellect Any Option',
            'subcategory_id.required' => 'Please Sellect Any Option',
        ]);
