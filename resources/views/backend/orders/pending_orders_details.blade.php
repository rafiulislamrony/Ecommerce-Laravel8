    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        <h4 class="box-title"><b>Order Details</b> <span class="text-danger">Invoice:{{
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="{{ route('shipped.dalivered', $order->id) }}"
                                    class="btn btn-block btn-success" id="dalivered">
                                    Dalivered Order
                                </a>
                                @elseif ($order->status == 'dalivered')
                                <a href="{{ route('dalivered.cancel', $order->id) }}"
