        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/shipping')? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'manage-division')? 'active' : '' }}" >
                        <a href="{{ route('manage-division') }}"><i class="ti-more"></i>Shiping Devision</a>
                    </li>
                    <li class="{{ ($route == 'manage-district')? 'active' : '' }}" >
                        <a href="{{ route('manage-district') }}"><i class="ti-more"></i>Shiping District</a>
                    </li>
                    <li class="{{ ($route == 'manage-state')? 'active' : '' }}" >
                        <a href="{{ route('manage-state') }}"><i class="ti-more"></i>Shiping State</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ ($prefix == '/orders')? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'dalivered-orders')? 'active' : '' }}" >
                        <a href="{{ route('dalivered-orders') }}"><i class="ti-more"></i>Dalivered Orders</a>
                    </li>
