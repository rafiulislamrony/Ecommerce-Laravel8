...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>BlackBox</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
                    BlackBox Head Office
                    Email:support@blackBox.com <br>
                    Mob: 1245454545 <br>
    ...
    <table width="100%">
        ...
        <tbody>
            ...
            <tr class="font">
                <td align="center">
                    <img src="{{ public_path($item->product->product_thambnial) }}" height="60px;" width="60px;" alt="">
                </td>
                ...
                <td align="center">{{ $item->product->qty }}</td>
