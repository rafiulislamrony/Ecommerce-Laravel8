...
<body class="cnt-home">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card" style="width: 18rem;">
                                <img src=" " id="pimage" class="card-img-top" alt="..." style=" width: 100%">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <ul class="list-group">
                                <li class="list-group-item">Product Price:
                                    <strong class="text-danger">$<span id="pprice"></span>
                                    </strong>
                                    <del id="oldprice">$</del>
                                </li>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="1" min="1" class="form-control" id="qty">
                            </div>
    ...
    <script type="text/javascript">
        //  For csrf token setup in meta tag
        $.ajaxSetup({
        headers: {
        ...
        function productView(id){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#pimage').attr('src','/'+data.product.product_thambnial);
                    $('#product_id').val(id);
                    $('#qty').val(1);
           ...
           $.ajax({
               ...
               success:function(response){
                   ...
                   $.each(response, function(key,value){
                       rows += `<tr>
                       <td class="col-md-2"><img src="/${value.product.product_thambnial} " alt="imga"></td>
                       <td class="col-md-7">
                        ...
                        <td class="col-md-1">
                            <button id="${value.id}" onclick="wishlistRemove(this.id)" type="submit"><i class="fa fa-times"></i> </button>
                        </td>
    ...
    <script type="text/javascript">
        function cart(){
           $.ajax({
               ...
               success:function(response){
                   ...
                   $.each(response.carts, function(key,value){
                       rows += `<tr>
                       <td><img src="/${value.options.image} " alt="imga" style="width: 100px;"></td>
                       <td>
        ...
        // cartRemove Remove End

        // Cart Incriment Start
