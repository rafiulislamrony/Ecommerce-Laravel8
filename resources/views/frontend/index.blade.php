                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a
                                                                ...
                                                                <img src="{{ asset($product->product_thambnial) }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                        ...
                        <div class="tab-pane" id="category{{$category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    ...
                                    @empty
                                    <h4 class="text-danger" style="font-weight: 700"> No Product Found </h4>
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'hindi') {{
                        $skip_category_0->category_name_hin }} @else {{
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'hindi') {{
                        $skip_category_1->category_name_hin }} @else {{
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'hindi') {{
                        $skip_brand_1->brand_name_hin }} @else {{
                        $skip_brand_1->brand_name_en }} @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
